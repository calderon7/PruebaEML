...
$('#submitButton').on('click', function (event) {
  ...
  function validateField(selector, alertSelector) {
    ...
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("3427694165_56_8_56_53_4", selector, alertSelector, isEmail)));
    var $field = $(selector);
  ...
  /* eslint-disable */
  (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3427694165_83_4_83_29_4", userStoreUrl)));
  ...
  if (isValid) {
    ...
    /* eslint-disable */
    (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("3427694165_100_8_100_25_4", data)));
    $.ajax({
      url: userStoreUrl,
      ...
      success: function success(response) {
        var _console4;
        /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("3427694165_109_16_109_49_4", 'Success:', response)));
        if (response.success) {
