...
$('#submitButton').on('click', function (event) {
  ...
  function validateField(selector, alertSelector) {
    ...
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("2291029539_56_8_56_53_4", selector, alertSelector, isEmail)));
    var $field = $(selector);
  ...
  /* eslint-disable */
  (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2291029539_83_4_83_29_4", userStoreUrl)));
  ...
  if (isValid) {
    ...
    /* eslint-disable */
    (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("2291029539_99_8_99_25_4", data)));
    $.ajax({
      url: "/users",
      // Cambia esta URL a la ruta donde se maneja el POST
      method: 'POST',
      data: data,
      headers: {
      ...
      success: function success(response) {
        var _console4;
        /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("2291029539_108_16_108_49_4", 'Success:', response)));
        if (response.success) {
