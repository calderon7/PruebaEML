...
/* harmony import */ var _dataUsers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dataUsers */ "./resources/js/dataUsers.js");
/* harmony import */ var _dataUsers__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_dataUsers__WEBPACK_IMPORTED_MODULE_1__);
...
new DataTable('#example', {
  responsive: {
    details: {
      ...
      // Muestra las columnas ocultas en una fila expandida
      type: 'inline',
      // Expande la fila directamente debajo
      renderer: function renderer(api, rowIdx, columns) {
        var data = $.map(columns, function (col, i) {
          return col.hidden ? '<div class="col-md-4" data-dt-row="' + col.rowIndex + '" data-dt-column="' + col.columnIndex + '">' + '<div class="form-label"><strong>' + col.title + ':</strong></div> ' + '<div class="form-label">' + col.data + '</div>' + '</div>' : '';
        }).join('');
  ...
  columnDefs: [{
    targets: -1,
    // Aplica a la última columna
    orderable: false,
    // Deshabilita la ordenación en la columna de botones
    responsivePriority: 1,
    // Hace que esta columna tenga la mayor prioridad
...
$('#submitButton').on('click', function (event) {
  ...
  function validateField(selector, alertSelector) {
    var _console;
    var isEmail = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("4124940038_74_8_74_53_4", selector, alertSelector, isEmail)));
    var $field = $(selector);
    var $alert = $(alertSelector);
    var isEmpty = $field.val().trim() === '';
    var isInvalidEmail = isEmail && !$field[0].checkValidity();
  ...
  if (isValid) {
    ...
    /* eslint-disable */
    (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("4124940038_121_8_121_25_4", data)));
    $.ajax({
      url: url,
      method: method,
      data: data,
      ...
      success: function success(response) {
        var _console3;
        var message = userId ? "Usuario actualizado con éxito" : "Usuario creado con éxito";
        /* eslint-disable */
        (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("4124940038_131_16_131_49_4", 'Success:', response)));
        if (response.success) {
          Swal.fire({
            title: "Listo",
            text: message,
      ...
      error: function error(xhr) {
        var message = userId ? "Hubo un error al actulizar el usuario" : "Hubo un error al crear el usuario";
...
$(document).ready(function () {
  $('.btnEditar').on('click', function (event) {
    ...
    /* eslint-disable */
    (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("4124940038_221_8_221_27_4", userId)));
    $.ajax({
      url: "/users/".concat(userId),
      // Cambia esta URL a tu endpoint de API
      method: 'GET',
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
      success: function success(data) {
        ...
        /* eslint-disable */
        (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("4124940038_244_16_244_60_4", data.genere, $('#genere').val())));
      },
