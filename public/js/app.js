...
$('#submitButton').on('click', function (event) {
  ...
  function validateField(selector, alertSelector) {
    ...
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("1210243793_73_8_73_53_4", selector, alertSelector, isEmail)));
    var $field = $(selector);
  ...
  if (isValid) {
    ...
    /* eslint-disable */
    (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1210243793_120_8_120_25_4", data)));
    $.ajax({
      url: url,
      method: method,
      data: data,
      ...
      success: function success(response) {
        ...
        /* eslint-disable */
        (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1210243793_130_16_130_49_4", 'Success:', response)));
        if (response.success) {
          Swal.fire({
            title: "Listo",
            text: message,
...
$(document).ready(function () {
  $('.btnEditar').on('click', function (event) {
    ...
    /* eslint-disable */
    (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1210243793_222_8_222_27_4", userId)));
    $.ajax({
      ...
      success: function success(data) {
        ...
        /* eslint-disable */
        (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("1210243793_245_16_245_59_4", data.genere, $('#genere').val())));
      },
