...
$('#submitButton').on('click', function (event) {
  ...
  function validateField(selector, alertSelector) {
    ...
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("892384274_55_8_55_53_4", selector, alertSelector, isEmail)));
    var $field = $(selector);
  ...
  if (isValid) {
    ...
    /* eslint-disable */
    (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("892384274_97_8_97_25_4", data)));
    $.ajax({
      url: "/users",
      method: 'POST',
      data: data,
      ...
      success: function success(response) {
        var _console3;
        /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("892384274_106_16_106_49_4", 'Success:', response)));
        if (response.success) {
          Swal.fire({
            title: "Listo",
...
$(document).ready(function () {
  $('.btnEditar').on('click', function (event) {
    ...
    /* eslint-disable */
    (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("892384274_193_8_193_27_4", userId)));
    $.ajax({
